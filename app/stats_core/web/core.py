...
def blueprint(runtime):
    ...
    def api_state():
        ...
        display_state = runtime.repos.display.get()
        return jsonify({
    ...
    def api_config():
        ...
        return jsonify({
            ...
            "screens": runtime.screens.list(),
            "display": runtime.display.state(),
    ...
    def api_save_config():
        ...
        try:
            saved = runtime.settings.update(body)
            if "active_mode" in body:
                runtime.display.sync_legacy_mode(saved.get("active_mode"))
    ...
    def api_leaderboard():
        ...
        if screen_id:
            payload = runtime.display.render(screen_id, **render_args)
        elif mode:
            payload = runtime.screens.render_mode(mode, **render_args)
        else:
            payload = runtime.display.render(**render_args)
        ...
        payload.update({
            ...
            "number_font_scale": 100 if custom else int(
